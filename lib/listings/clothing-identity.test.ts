...
describe("clothing identity — Tweety photo set", () => {
  ...
  it("second pass upgrades generic garment to Tweety identity", () => {
    ...
    const merged = mergeIdentitySecondPass(first, {
      ...
      waistSize: field("Unknown", 0.1),
      inseam: field("Unknown", 0.1),
      fit: field("Unknown", 0.1),
      rise: field("Unknown", 0.1),
      closure: field("Unknown", 0.1),
      fabricWash: field("Unknown", 0.1),
      pocketType: field("Unknown", 0.1),
      fabricType: field("Unknown", 0.1),
      garmentCare: field("Unknown", 0.1),
      sizeType: field("Unknown", 0.1),
      season: field("Unknown", 0.1),
      accents: field("Unknown", 0.1),
      model: field("Unknown", 0.1),
      productLine: field("Unknown", 0.1),
      mpn: field("Unknown", 0.1),
      upc: field("Unknown", 0.1),
      pattern: field("Black and white gingham/check", 0.9),
